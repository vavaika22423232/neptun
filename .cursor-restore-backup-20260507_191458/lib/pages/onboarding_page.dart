  ...
  Future<void> _finishOnboarding() async {
    ...
    try {
      ...
      if (_selectedRegions.isNotEmpty) {
        ...
        final oblastIds = fullNames
            .map(regionDb.getOblastIdByName)
            .whereType<String>()
            .toSet()
            .toList();
        ...
        ); // legacy, first for backwards compat
        await prefs.setStringList('selected_regions', fullNames);
        await prefs.setStringList('selected_oblast_ids', oblastIds);
        try {
                    ...
                    children: [
                      ...
                      if (_currentPage == 0 || _currentPage == _totalPages - 1)
                        NeptunButton(
                          ...
                          isLoading:
                              _currentPage == _totalPages - 1 && _isFinishing,
                        ),
                    ],
                  ),
                ),
