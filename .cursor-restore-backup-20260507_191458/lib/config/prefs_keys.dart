...
class PrefsKeys {
  ...
  /// Alias для нового коду вибору регіонів (те саме сховище, що й [subscribedRegions]).
  static const String selectedRegions = subscribedRegions;
  ...
  // ===== PRO: Чат (кастомізація) =====
  static const String proChatThemeId = 'pro_chat_theme_id';
  static const String proAnimatedAvatar = 'pro_animated_avatar';
}
