...
class ApiConfig {
  ...
  /// Вимоги до мінімальної версії застосунку (`/api/app-requirements`).
  static const Duration appRequirementsHttpTimeout = Duration(seconds: 12);

  static const String appRequirementsPath = '/api/app-requirements';

  /// Повний URL для перевірки app requirements.
  static String get appRequirements => '$baseUrl$appRequirementsPath';

  /// Абсолютний URL для відносного шляху або повертає вже абсолютний.
  ...
  /// Alias для коду, що очікує `resolveAbsoluteUrl`.
  static String resolveAbsoluteUrl(String path) => absoluteUrl(path);
}
