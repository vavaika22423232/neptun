...
UA_CITY_NORMALIZE = {
    ...
    # Новые формы для многословных населенных пунктов в винительном падеже
    'малу дівицю':'мала дівиця',
    'мала дівицю':'мала дівиця',
    'згурівку':'згурівка',
    'олишівку':'олишівка',
    'ставище':'ставище',
    'ставищею':'ставище',
...
CITY_COORDS = {
    ...
    # --- Added from user messages (2025-08-30) ---
    'золотоноша': (49.6672, 32.0401),  # Черкаська обл.
    'сарни': (51.3462, 26.6013),  # Рівненська обл.
    'березне': (51.0052, 26.7522),  # Рівненська обл.
    'корсунь-шеваченківський': (49.4197, 31.2731),  # Черкаська обл.
    'овруч': (51.3262, 28.8031),  # Житомирська обл.
    'звягель': (50.5946, 27.6207),  # Житомирська обл. (Новоград-Волинський)
    'ірпінь': (50.5216, 30.2505),  # Київська обл.
    'сміла': (49.2226, 31.8687),  # Черкаська обл.
    'березівка': (47.2047, 30.9717),  # Одеська обл.
    'очаків': (46.6131, 31.5497),  # Миколаївська обл.
    'чорнобаївка': (46.6550, 32.6172),  # Херсонська обл.
    'вишгород': (50.5840, 30.4890),  # Київська обл.
    'дружківка': (48.6208, 37.5272),  # Донецька обл.
    'шостка': (51.8667, 33.4833),  # Сумська обл.
    'вознесенськ': (47.5647, 31.3369),  # Миколаївська обл.
    'снігурівка': (47.0806, 32.8092),  # Миколаївська обл.
    'бровари': (50.5111, 30.7900),  # Київська обл.
    'жашків': (49.2431, 30.1122),  # Черкаська обл.
    'талне': (48.8872, 30.7056),  # Черкаська обл.
    'світловодськ': (49.0486, 33.2417),  # Кіровоградська обл.
    'яготин': (50.2360, 31.7700),  # Київська обл.
    'березань': (50.3085, 31.4576),  # Київська обл.
    'бортничі': (50.3915, 30.6695),  # Київ
    'старокостянтинів': (49.7574, 27.2039),  # Хмельницька обл.
    'адампіль': (49.6500, 27.3000),  # Хмельницька обл.
    'олишівка': (51.0725, 31.3525),  # Чернігівська обл.
    'узин': (49.8216, 30.4567),  # Київська обл.
    'бориспіль': (50.3527, 30.9550),  # Київська обл.
    'жуляни': (50.4017, 30.4519),  # Київ
    'ржищів': (49.9719, 31.0500),  # Київська обл.
    'старий остропіль': (49.6503, 27.2291),  # Хмельницька обл.
    'конча-заспа': (50.2650, 30.5760),  # Київ
    'любар': (50.0500, 27.7500),  # Житомирська обл.
    'вишеньки': (50.2987, 30.6445),  # Київська обл.
    'троєщина': (50.5130, 30.6030),  # Київ
    'троєщину': (50.5130, 30.6030),  # Київ (вин. падеж)
    'коростень': (50.9500, 28.6333),  # Житомирська обл.
    'радомишль': (50.4972, 29.2292),  # Житомирська обл.
    'погребище': (49.4833, 29.2667),  # Вінницька обл.
    'теплик': (48.6667, 29.6667),  # Вінницька обл.
    'оратів': (48.9333, 29.5167),  # Вінницька обл.
    'дашів': (48.9000, 29.4333),  # Вінницька обл.
    'шаргород': (48.7333, 28.0833),  # Вінницька обл.
    # --- Альтернативные формы для парсинга ---
    'Корсунь-Шевченківський': (49.4197, 31.2731),
    'Овруч': (51.3262, 28.8031),
    'Звягель': (50.5946, 27.6207),
    'Золотоноша': (49.6672, 32.0401),
    'Сарни': (51.3462, 26.6013),
    'Березне': (51.0052, 26.7522),
    'Бердичів': (49.8981, 28.5746),
    'Обухів': (50.1072, 30.6211),
    'Кагарлик': (49.5217, 30.8192),
    'Миронівка': (49.6631, 31.0100),
    'Сміла': (49.2226, 31.8687),
    'Дружківка': (48.6208, 37.5272),
    'Богуслав': (49.5672, 30.8706),  # Київська обл.
    'Очаків': (46.6131, 31.5497),
    ...
    ,'старий салтів': (50.0847, 36.7424)  # Added to duplicate dict
    ,'борки': (49.9380, 36.1260)  # Added to duplicate dict
    ,'кролевець': (51.5481, 33.3847)
    ...
    ,'балаклія': (49.4627, 36.8586)  # Балаклія, Харківська обл.
    ,'савинці': (49.4365, 37.2981)  # Савинці, Харківська обл.
    ,'шевченкове': (49.6996, 37.1770)  # Шевченкове, Харківська обл.
    ...
    ,'блистова': (51.6833, 32.6333)
    ,'ніжин': (51.0480, 31.8860)
    ,'мена': (51.5211, 32.2147)
    ,'десна': (51.0833, 30.9333)
    ,'євминка': (51.3167, 31.7167)
    ,'м.-коцюбинське': (51.5833, 31.1167)
    ,'лосинівка': (51.1333, 31.7167)
    ,'ічня': (51.0722, 32.3931)
    ,'борзна': (51.2542, 32.4192)
    ,'прилуки': (50.5931, 32.3878)
    ,'линовиця': (50.7833, 32.4167)
    ...
    ,'затока': (46.0660, 30.4680)  # Zatoka (Bilhorod-Dnistrovskyi raion, Odesa oblast) for parenthetical direction parsing

    # --- Новые населённые пункты для отображения на карте ---
    ,'янське': (48.4567, 36.3342)  # Янське, Днепропетровская обл. (или Кам'янське, если это опечатка)
    ,'чугуїв': (49.8376, 36.6881)  # Чугуїв, Харківська обл.
    ,'ворожба': (51.8031, 34.4972)  # Ворожба, Сумська обл.
    ,'краснопілля': (50.4422, 35.3081)  # Краснопілля, Сумська обл.
    ,'бориспіль': (50.3498, 30.9550)  # Бориспіль, Київська обл.
    ,'жашків': (49.2431, 30.1122)  # Жашків, Черкаська обл.
    ,'есмань': (51.8833, 34.2833)  # Есмань, Сумська обл.
    ,'мерефа': (49.8181, 36.0572)  # Мерефа, Харківська обл.
    ,'берестин': (50.2000, 35.0000)  # Берестин, Харківська обл. (уточнить координаты при необходимости)
    ,'глухів': (51.6781, 33.9169)  # Глухів, Сумська обл.
    ,'недригайлів': (50.8281, 33.8781)  # Недригайлів, Сумська обл.
    ,'вороніж': (51.8081, 33.3722)  # Вороніж, Сумська обл.
    ,'ромни': (50.7497, 33.4746)  # Ромни, Сумська обл.
    ,'узин': (49.8131, 30.4061)  # Узин, Київська обл.
    ,'гончарівське': (51.6272, 31.3192)  # Гончарівське, Чернігівська обл.
    ,'балаклія': (49.4622, 36.8572)  # Балаклія, Харківська обл.
    ,'голованівськ': (48.3772, 30.5322)  # Голованівськ, Кіровоградська обл.
    ,'новоукраїнка': (48.3122, 31.5272)  # Новоукраїнка, Кіровоградська обл.
    ,'тульчин': (48.6742, 28.8672)  # Тульчин, Вінницька обл.
    ,'бровари': (50.5111, 30.7900)  # Бровари, Київська обл.
    ,'канів': (49.7444, 31.4697)  # Канів, Черкаська обл.
    ,'миронівка': (49.6631, 31.0100)  # Миронівка, Київська обл.
    ,'обухів': (50.1072, 30.6211)  # Обухів, Київська обл.
    ,'радомишль': (50.4972, 29.2292)  # Радомишль, Житомирська обл.
    ,'ромни': (50.7497, 33.4746)  # Ромни, Сумська обл.
    ,'златопіль': (48.3640, 38.1500)  # Златопіль, Харківська обл. (или уточнить)
    ,'борова': (49.3742, 36.4892)  # Борова, Харківська обл.
    ,'буринь': (51.2000, 33.8500)  # Буринь, Сумська обл.
    ,'конотоп': (51.2417, 33.2022)  # Конотоп, Сумська обл.
    ,'остер': (50.9481, 30.8831)  # Остер, Чернігівська обл.
    ,'плавні': (49.0123, 33.6450)  # Горішні Плавні, Полтавська обл.

    # --- Районы и новые населённые пункты для последних сообщений ---
    ,'голованівський район': (48.3772, 30.5322)  # Центр Голованівського району (Голованівськ)
    ,'новоукраїнський район': (48.3122, 31.5272)  # Центр Новоукраїнського району (Новоукраїнка)
    ,'безлюдівка': (49.8872, 36.2731)  # Безлюдівка, Харківська обл.
    ,'рогань': (49.9342, 36.4942)  # Рогань, Харківська обл.
    ,'савинці': (49.6272, 36.9781)  # Савинці, Харківська обл. (есть и в других областях, но по контексту — Харьковская)

    # --- Новые населённые пункты для курсов БпЛА ---
    ,'українка': (50.1447, 30.7381)  # Украинка, Киевская обл.
    ,'чорнобиль': (51.2768, 30.2219)  # Чорнобиль, Киевская обл.
    ,'царичанка': (48.9767, 34.3772)  # Царичанка, Днепропетровская обл.
    ,'семенівка': (51.6542, 32.5667)  # Семенівка, Черниговская обл.
    ,'шишаки': (49.8992, 34.0072)  # Шишаки, Полтавская обл.
    ,'ріпки': (51.8122, 31.0817)  # Ріпки, Черниговская обл.
    ,'михайло-коцюбинське': (51.5833, 31.1167)  # Михайло-Коцюбинське, Черниговская обл.
    ,'макошине': (51.6275, 32.2731)  # Макошине, Черниговская обл.
    ,'парафіївка': (50.9833, 32.2833)  # Парафіївка, Черниговская обл.
    ,'дубовʼязівка': (51.1833, 33.7833)  # Дубовʼязівка, Сумская обл.
    # Уже были, но дублируем для надёжности
    ,'липову долину': (50.5700, 33.7900)  # Accusative form
    ,'линовиця': (50.7833, 32.4167)
    ,'улянівка': (50.8530, 34.3170)
    ,'боромля': (50.7500, 34.9833)  # Боромля, Сумская обл.
    # --- Новые населённые пункты из примера пользователя (многострочные сообщения не отображались) ---
    ,'жукин': (50.7800, 30.6820)  # Жукин, Київщина
    ,'велика димерка': (50.8140, 30.8080)  # Велика Димерка, Київщина
    ,'велику димерку': (50.8140, 30.8080)  # вин.падеж
    ,'вишгород': (50.5840, 30.4890)  # Вишгород, Київщина
    ,'ржищів': (49.9719, 31.0500)  # Ржищів, Київщина
    ,'вишеньки': (50.2987, 30.6445)  # Вишеньки (село, Київщина)
    ,'жуляни': (50.4017, 30.4519)  # Жуляни (аеропорт, район Києва)
    ,'троєщина': (50.5130, 30.6030)  # Троєщина (район Києва)
    ,'троєщину': (50.5130, 30.6030)  # вин.падеж
    ,'конча-заспа': (50.2650, 30.5760)  # Конча-Заспа (південь Києва)
    ,'любар': (50.0500, 27.7500)  # Любар, Житомирщина
    ,'старий остропіль': (49.6503, 27.2291)  # Старий Остропіль, Хмельниччина
    # Новые города из последнего сообщения пользователя
    ...
    ,'адампіль': (49.6500, 27.3000)  # приблизительно, уточнить при необходимости
...
def process_message(text, mid, date_str, channel):
    ...
    def normalize_city_name(name):
        ...
        # Удалить markdown (**, __, `)
        n = re.sub(r'[\*\_\`]', '', n)
        # Удалить эмодзи и все не-буквы, кроме дефиса и пробела
        n = re.sub(r'[^a-zа-яіїєґё\-\'\s]', '', n)
    ...
    try:
        import re as _re_fb
        _fb_low = original_text.lower()
        fb_keys = [
            'загроза застосування бпла',
            'активність розвідувальних бпла',
            'активність розвідувальних',
            'загроза застосування безпілот',
        ]
        if any(k in _fb_low for k in fb_keys):
...
UA_CITY_NORMALIZE = {
    ...
    'николаев':'миколаїв',
    'чернигов':'чернігів',
    # Extended normalization (multi-line UAV course parsing)
    'олишівку':'олишівка',
    'малу дівицю':'мала дівиця',
    'мала дівицю':'мала дівиця',
    'згурівку':'згурівка',
