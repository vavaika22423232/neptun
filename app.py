...
CITY_COORDS = {
    ...
    'страхолісся': (50.5167, 30.8833), 'велика димерка': (50.5167, 30.5833), 'білокоровичі': (51.1667, 27.75),
    'краснопалівка': (50.0167, 35.95), 'божедрівка': (48.4167, 35.0167), 'пʼятихатки': (48.5667, 33.6833),
    ...
    'дубовʼязівка': (50.7833, 34.3667), 'дубовʼязівку': (50.7833, 34.3667), "дуб'язівка": (50.7833, 34.3667),
    ...
    'ямпіль': (48.1333, 28.2833), 'ямполю': (48.1333, 28.2833), 'ямполі': (48.1333, 28.2833),
...
def process_message(text, mid, date_str, channel):  # type: ignore
    ...
    if region_count >= 2 and uav_count >= 3:
        ...
        for line in text_lines:
            ...
            if 'бпла' in line_lower and ('курс' in line_lower or ' на ' in line_lower or 'над' in line_lower):
