...
HARDCODED_COORDS = {
    ...
    'кривий ріг|дніпропетровська': (47.9108, 33.3917),
    ...
    # === FREQUENTLY MISSED CITIES (added for BPLA tracking) ===
    'вільнянськ': (47.9431, 35.4083),
    'вільнянськ|запорізька': (47.9431, 35.4083),
    'умань': (48.7481, 30.2217),
    'умань|черкаська': (48.7481, 30.2217),
    'шахтарське': (48.0500, 38.4667),
    'шахтарське|донецька': (48.0500, 38.4667),
    'славгород': (48.7333, 35.4167),
    'славгород|дніпропетровська': (48.7333, 35.4167),
    'долинська': (48.1000, 32.7667),
    'долинська|кіровоградська': (48.1000, 32.7667),
    'очаків': (46.6167, 31.5500),
    'очаків|миколаївська': (46.6167, 31.5500),
    'олександрія': (48.6697, 33.1081),
    'олександрія|кіровоградська': (48.6697, 33.1081),
    'новоукраїнка': (48.3144, 31.5375),
    'новоукраїнка|кіровоградська': (48.3144, 31.5375),
    'знам\'янка': (48.7167, 32.6667),
    'знам\'янка|кіровоградська': (48.7167, 32.6667),
    'світловодськ': (49.0489, 33.2542),
    'світловодськ|кіровоградська': (49.0489, 33.2542),
    'первомайськ': (48.0500, 30.8500),
    'первомайськ|миколаївська': (48.0500, 30.8500),
    'вознесенськ': (47.5667, 31.3167),
    'вознесенськ|миколаївська': (47.5667, 31.3167),
    'новий буг': (47.6833, 32.5167),
    'новий буг|миколаївська': (47.6833, 32.5167),
    'баштанка': (47.4167, 32.4333),
    'баштанка|миколаївська': (47.4167, 32.4333),
    'снігурівка': (47.0667, 32.8000),
    'снігурівка|миколаївська': (47.0667, 32.8000),
    'нікополь': (47.5706, 34.3919),
    'нікополь|дніпропетровська': (47.5706, 34.3919),
    'марганець': (47.6333, 34.6167),
    'марганець|дніпропетровська': (47.6333, 34.6167),
    'новомосковськ': (48.6333, 35.2333),
    'новомосковськ|дніпропетровська': (48.6333, 35.2333),
    'синельникове': (48.3167, 35.5167),
    'синельникове|дніпропетровська': (48.3167, 35.5167),
    'апостолове': (47.6589, 33.7197),
    'апостолове|дніпропетровська': (47.6589, 33.7197),
    'зеленодольськ': (48.5000, 33.6500),
    'зеленодольськ|дніпропетровська': (48.5000, 33.6500),
    'п\'ятихатки': (48.4167, 33.7167),
    'п\'ятихатки|дніпропетровська': (48.4167, 33.7167),
    'жовті води': (48.3500, 33.5000),
    'жовті води|дніпропетровська': (48.3500, 33.5000),
    'тернівка': (48.5167, 34.9833),
    'тернівка|дніпропетровська': (48.5167, 34.9833),
    'вербки': (48.6667, 34.2833),
    'вербки|дніпропетровська': (48.6667, 34.2833),
    'покров': (47.6500, 35.4833),
    'покров|дніпропетровська': (47.6500, 35.4833),
    'золотоноша': (49.6833, 32.0333),
    'золотоноша|черкаська': (49.6833, 32.0333),
    'сміла': (49.2167, 31.8667),
    'сміла|черкаська': (49.2167, 31.8667),
    'канів': (49.7500, 31.4667),
    'канів|черкаська': (49.7500, 31.4667),
    'шпола': (49.0000, 31.4000),
    'шпола|черкаська': (49.0000, 31.4000),
    'ватутіне': (49.0167, 31.0667),
    'ватутіне|черкаська': (49.0167, 31.0667),
    'конотоп': (51.2333, 33.2000),
    'конотоп|сумська': (51.2333, 33.2000),
    'охтирка': (50.3000, 34.9000),
    'охтирка|сумська': (50.3000, 34.9000),
    'шостка': (51.8667, 33.4833),
    'шостка|сумська': (51.8667, 33.4833),
    'ромни': (50.7500, 33.4667),
    'ромни|сумська': (50.7500, 33.4667),
    'лебедин': (50.5833, 34.4833),
    'лебедин|сумська': (50.5833, 34.4833),
    'глухів': (51.6833, 33.9167),
    'глухів|сумська': (51.6833, 33.9167),
    'білопілля': (51.1500, 34.3000),
    'білопілля|сумська': (51.1500, 34.3000),
    'тростянець': (50.4833, 34.9667),
    'тростянець|сумська': (50.4833, 34.9667),
    'буринь': (51.2000, 33.8167),
    'буринь|сумська': (51.2000, 33.8167),
    
    # === POLTAVSKA OBLAST ===
    'семенівка': (50.0833, 33.5333),
    'семенівка|полтавська': (50.0833, 33.5333),
    'хорол': (49.7833, 33.2667),
    'хорол|полтавська': (49.7833, 33.2667),
    'миргород': (49.9667, 33.6000),
    'миргород|полтавська': (49.9667, 33.6000),
    'лубни': (50.0167, 32.9833),
    'лубни|полтавська': (50.0167, 32.9833),
    'гадяч': (50.3667, 33.9833),
    'гадяч|полтавська': (50.3667, 33.9833),
    'глобине': (49.3833, 32.5667),
    'глобине|полтавська': (49.3833, 32.5667),
    'карлівка': (49.4500, 35.1333),
    'карлівка|полтавська': (49.4500, 35.1333),
    'пирятин': (50.2333, 32.5167),
    'пирятин|полтавська': (50.2333, 32.5167),
    
    # === MYKOLAIVSKA OBLAST ===
    'казанка': (47.8823, 32.7630),
    'казанка|миколаївська': (47.8463, 32.8218),
    'возсіятське': (47.6696, 32.1136),
    'возсіятське|миколаївська': (47.6696, 32.1136),
    
    # === KIROVOHRADSKA OBLAST ===
    'бобринець': (48.0573, 32.1594),
    'бобринець|кіровоградська': (48.0573, 32.1594),
}
...
def _normalize_key(city: str, region: str = None) -> str:
    ...
    if region:
        ...
        # IMPORTANT: Convert "щина" forms to "ська" forms for key matching
        # "полтавщина" -> "полтавська", "сумщина" -> "сумська", etc.
        region_transforms = {
            ...
            'івано-франківщина': 'івано-франківська',
            'закарпаття': 'закарпатська',
        }
        region_norm = region_transforms.get(region_norm, region_norm)
...
PRIORITY_OBLAST_BOUNDS = {
    ...
    'дніпропетровська': (47.5, 49.5, 33.0, 37.0),  # Extended east to include Mezhova
    'дніпропетровськ': (47.5, 49.5, 33.0, 37.0),
...
def geocode(city: str, region: str = None) -> tuple:
    ...
    # === VALIDATION: Reject phrases, only accept city names ===
    # City names are typically 1-3 words (e.g., "Кривий Ріг", "Біла Церква")
    city_stripped = city.strip()
    word_count = len(city_stripped.split())
    
    # Reject if too many words (likely a phrase, not a city name)
    if word_count > 4:
        print(f"[OPENCAGE] Rejected: '{city_stripped[:50]}...' has {word_count} words (max 4)", flush=True)
        return None
    
    # Reject common phrases that are NOT city names
    phrase_indicators = [
        ' в ', ' на ', ' до ', ' з ', ' від ', ' над ', ' під ', ' через ',
        ' поруч ', ' біля ', ' коло ', ' напрямк', ' курс', ' сторон',
        ' балалай', ' нових ', ' будуть ', ' вже ', ' зараз ', ' там ',
        ' потім ', ' далі ', ' ще '
    ]
    city_lower = city_stripped.lower()
    for indicator in phrase_indicators:
        if indicator in city_lower:
            print(f"[OPENCAGE] Rejected phrase: '{city_stripped[:50]}' contains '{indicator.strip()}'", flush=True)
            return None
    
    # Reject if too long (city names are usually short)
    if len(city_stripped) > 40:
        print(f"[OPENCAGE] Rejected: '{city_stripped[:30]}...' is too long ({len(city_stripped)} chars)", flush=True)
        return None
