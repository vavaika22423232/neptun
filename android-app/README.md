...
- ✅ **OpenStreetMap** (як в оригінальному веб-додатку)
...
- **OpenStreetMap (osmdroid)** - відображення карти (як на сайті!)
- **Retrofit** - HTTP клієнт для API
- **Coroutines** - асинхронність
- **ViewModel** - управління станом
- **Material Design 3** - дизайн система

## 🗺️ Чому OpenStreetMap?

Як і в оригінальному веб-додатку, використовується **OpenStreetMap** замість Google Maps:
- ✅ Безкоштовно (без API ключів!)
- ✅ Відкрите джерело
- ✅ Точно як на сайті neptun.onrender.com
- ✅ Не потребує Google Play Services
