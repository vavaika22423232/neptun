...
# Empty - rely on API for geocoding, no hardcoded overrides
HARDCODED_COORDS = {}

# Use /data for persistent storage on VPS, fallback to local dir
...
def _normalize_city_name(city: str) -> str:
    ...
    known_transforms = {
        ...
        'бровари': 'Бровари',
        'славутичу': 'Славутич',
        'слобожанському': 'Слобожанське',  # Чугуївський р-н, НЕ Ізюмський!
...
PRIORITY_OBLAST_BOUNDS = {
    'харківська': (48.0, 51.0, 34.0, 39.0),
    'харківськ': (48.0, 51.0, 34.0, 39.0),
    'донецька': (46.5, 50.0, 36.0, 40.0),
    'донецьк': (46.5, 50.0, 36.0, 40.0),
    'луганська': (47.5, 50.5, 37.0, 41.0),
    'луганськ': (47.5, 50.5, 37.0, 41.0),
    'запорізька': (46.0, 49.0, 33.5, 38.0),
    'запорізьк': (46.0, 49.0, 33.5, 38.0),
    'херсонська': (45.0, 48.0, 31.5, 36.0),
    'херсонськ': (45.0, 48.0, 31.5, 36.0),
    'дніпропетровська': (47.0, 50.0, 32.5, 37.5),
    'дніпропетровськ': (47.0, 50.0, 32.5, 37.5),
    'миколаївська': (45.5, 49.0, 30.0, 34.0),
    'миколаївськ': (45.5, 49.0, 30.0, 34.0),
    'одеська': (44.5, 49.0, 28.0, 31.5),  # max_lng: exclude Kryvyi Rih (33.39°)
    'одеськ': (44.5, 49.0, 28.0, 31.5),
    'полтавська': (48.0, 51.0, 31.5, 36.0),
    'полтавськ': (48.0, 51.0, 31.5, 36.0),
    'сумська': (49.5, 53.0, 32.0, 36.0),
    'сумськ': (49.5, 53.0, 32.0, 36.0),
    'чернігівська': (50.0, 53.0, 30.0, 34.0),
    'чернігівськ': (50.0, 53.0, 30.0, 34.0),
    'київська': (48.5, 52.0, 28.5, 33.0),
    'київськ': (48.5, 52.0, 28.5, 33.0),
    'черкаська': (48.0, 50.5, 30.0, 33.5),
    'черкаськ': (48.0, 50.5, 30.0, 33.5),
    'кіровоградська': (47.0, 50.0, 30.0, 34.0),
    'кіровоградськ': (47.0, 50.0, 30.0, 34.0),
}
...
def geocode(city: str, region: str = None) -> tuple:
    ...
    city_stripped = strip_settlement_prefix(city.strip()) or city.strip()
...
# Alias for geo.resolver cascade
