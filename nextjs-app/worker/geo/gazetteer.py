...
_MANUAL_PLACES: dict[str, tuple[str, float, float, str, Optional[str], str, int]] = {
    ...
    'клембівка': ('Клембівка', 48.3899920, 28.4056720, 'Вінницька область', 'Могилів-Подільський', 'село', 3500),
    'клембивка': ('Клембівка', 48.3899920, 28.4056720, 'Вінницька область', 'Могилів-Подільський', 'село', 3500),
    # Odesa city microdistricts / beaches. External geocoders often resolve
    # these names to same-named villages across the oblast, which is worse than
    # suppressing. Keep them pinned to the city-local reference points.
    'молдаванка': ('Молдаванка', 46.4749000, 30.7134000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'молдаванкой': ('Молдаванка', 46.4749000, 30.7134000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'молдаванке': ('Молдаванка', 46.4749000, 30.7134000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'отрада': ('Отрада', 46.4696000, 30.7585000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'отрадой': ('Отрада', 46.4696000, 30.7585000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'отраде': ('Отрада', 46.4696000, 30.7585000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'ленпаселок': ('Ленпаселок', 46.4359000, 30.6339000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'ленпоселок': ('Ленпаселок', 46.4359000, 30.6339000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'ленпосёлок': ('Ленпаселок', 46.4359000, 30.6339000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'малий фонтан': ('Малий Фонтан', 46.4288000, 30.7546000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'малый фонтан': ('Малий Фонтан', 46.4288000, 30.7546000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'слободка': ('Слободка', 46.4906000, 30.6950000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'слобідка': ('Слободка', 46.4906000, 30.6950000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'порт': ('Порт', 46.4880000, 30.7419000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'совиньон': ('Совиньон', 46.3546000, 30.6967000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'таїрово': ('Таїрово', 46.3886000, 30.7104000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'таірово': ('Таїрово', 46.3886000, 30.7104000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'таирово': ('Таїрово', 46.3886000, 30.7104000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'тайрово': ('Таїрово', 46.3886000, 30.7104000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'вузовский': ('Вузовський', 46.4133000, 30.7203000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'вузовський': ('Вузовський', 46.4133000, 30.7203000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'черемушки': ('Черемушки', 46.4288000, 30.7087000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'черёмушки': ('Черемушки', 46.4288000, 30.7087000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'черемушкі': ('Черемушки', 46.4288000, 30.7087000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'черемушках': ('Черемушки', 46.4288000, 30.7087000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'черёмушках': ('Черемушки', 46.4288000, 30.7087000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
    'лиманка': ('Лиманка', 46.3636000, 30.6585000, 'Одеська область', 'Одеський', 'neighbourhood', 0),
}
