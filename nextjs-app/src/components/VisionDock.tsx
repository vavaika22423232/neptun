  ...
  return (
    <div className="fixed bottom-safe pb-6 left-1/2 -translate-x-1/2 z-[1500]">
      <div className={`p-2 flex items-center gap-3 ${glass.dock}`}>
        ...
        {/* Apple Icon */}
        <a href={APP_STORE_URL} target="_blank" rel="noopener noreferrer" className={`w-12 h-12 flex items-center justify-center ${glass.button}`}>
        ...
        {/* Play Icon */}
        <a href={GOOGLE_PLAY_URL} target="_blank" rel="noopener noreferrer" className={`w-12 h-12 flex items-center justify-center ${glass.button}`}>
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 opacity-80">
