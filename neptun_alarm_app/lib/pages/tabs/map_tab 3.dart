...
class _MapTabState extends State<MapTab> with AutomaticKeepAliveClientMixin {
  ...
  void didChangeDependencies() {
    ...
    if (!_webViewInitialized) {
      ...
      // iOS: defer WKWebView platform view until after first frame — reduces races with ATT / IAP / engine init.
      if (Platform.isIOS) {
    ...
    try {
      ...
      ctrl.addJavaScriptChannel(
        ...
        onMessageReceived: (JavaScriptMessage javascriptMessage) {
          _handleNeptunAppMessage(javascriptMessage.message);
        },
      );
      ...
      appTaggedLog('WebView init error: $e', tag: 'map_tab');
      if (mounted) {
        setState(() {
          _platformError = true;
          _isLoading = false;
