  ...
  AppRouter({required this.prefs}) {
    router = GoRouter(
      ...
      routes: [
        ...
        GoRoute(
          path: '/regions',
          redirect: (context, state) => RoutePaths.radarRegionsView,
        ),
        GoRoute(
        ...
        GoRoute(
          path: RoutePaths.feedbackModeration,
  ...
  static CustomTransitionPage<void> _shellTabPage(
    ...
    return CustomTransitionPage<void>(
      ...
      transitionDuration: reduceMotion
          ? Duration.zero
          : AppConstants.bottomNavSelectionDuration,
