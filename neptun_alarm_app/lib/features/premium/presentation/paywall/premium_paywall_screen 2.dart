                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                    _HeroBlock(
                      ...
                      showAcquisitionPitch: !state.isPremium,
                    ),
                    ...
                    Text(
                      'щомісячна підписка · скасуйте будь-коли',
                      textAlign: TextAlign.center,
                      style: GoogleFonts.plusJakartaSans(
                        fontSize: 14,
                    ...
                    const SizedBox(height: 20),
                    Text(
                      'Оплата через Apple або Google.\nПідписку можна скасувати будь-коли в налаштуваннях магазину.',
                      textAlign: TextAlign.center,
                      style: GoogleFonts.plusJakartaSans(
                        fontSize: 12,
                        height: 1.55,
                    ...
                    const SizedBox(height: 28),
                    Text(
                      'Дякуємо, що розглядаєте підтримку проєкту.',
                      textAlign: TextAlign.center,
                      style: GoogleFonts.plusJakartaSans(
                        fontSize: 12,
                        height: 1.5,
...
class _HeroBlock extends StatelessWidget {
  const _HeroBlock({
    ...
    required this.showAcquisitionPitch,
  });

  final PremiumPaywallStyle style;
  final bool isPremium;
  final bool showAcquisitionPitch;
...
class _TrustLine extends StatelessWidget {
  const _TrustLine({required this.style});
  ...
  Widget build(BuildContext context) {
    return Text(
      '•  щомісячна підписка  ·  скасуйте будь-коли  ·  миттєвий доступ',
      textAlign: TextAlign.center,
      style: GoogleFonts.plusJakartaSans(
        fontSize: 12,
        fontWeight: FontWeight.w600,
...
class _FeaturesPanel extends StatelessWidget {
  const _FeaturesPanel({required this.style, required this.entrance});

  final PremiumPaywallStyle style;
  final Animation<double> entrance;

  static const _items = <(ProFeature, IconData, bool)>[
    (ProFeature.preciseRaionPush, Icons.location_on_rounded, true),
    (ProFeature.noAds, Icons.block_rounded, false),
    (ProFeature.sleepMode, Icons.bedtime_rounded, false),
    (ProFeature.detailedPush, Icons.notifications_active_rounded, false),
    (ProFeature.extendedRadar, Icons.radar_rounded, false),
    (ProFeature.alarmHistory, Icons.history_rounded, false),
    (ProFeature.personalAnalytics, Icons.analytics_rounded, false),
    (ProFeature.heatmap, Icons.whatshot_rounded, false),
    (ProFeature.customAlarmSounds, Icons.volume_up_rounded, false),
    (ProFeature.widgetCustomization, Icons.widgets_rounded, false),
    (ProFeature.chatThemes, Icons.palette_rounded, false),
    (ProFeature.animatedAvatar, Icons.motion_photos_on_rounded, false),
  ];
    ...
    return DecoratedBox(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(
          _PremiumPaywallScreenState._kPanelRadius,
        ),
        color: style.panel,
...
class _FeatureRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final name = ProGate.featureNames[feature] ?? '';
    final desc = ProGate.featureDescriptions[feature] ?? '';
      ...
      child: BackdropFilter(
        ...
        child: DecoratedBox(
          decoration: BoxDecoration(
            ...
            border: Border(top: BorderSide(color: style.hairline)),
          ),
          child: SafeArea(
            top: false,
