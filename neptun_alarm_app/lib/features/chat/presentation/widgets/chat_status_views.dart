...
class ChatRulesView extends StatelessWidget {
  ...
  const ChatRulesView({super.key, required this.onAgree, required this.background});
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildRule(context, 'Будьте ввічливими', 'Поважайте інших учасників чату та їх думку.'),
                  _buildRule(context, 'Без спаму', 'Не надсилайте однакові повідомлення або беззмістовний текст.'),
                  _buildRule(context, 'Без мату', 'Ми підтримуємо культурне спілкування без нецензурної лексики.'),
                  _buildRule(context, 'Без реклами', 'Реклама сторонніх ресурсів або послуг суворо заборонена.'),
                  const SizedBox(height: 28),
                  Semantics(
                    button: true,
        ...
        child: Column(
          ...
          children: [
            CircleAvatar(
              ...
              child: Icon(Icons.block_rounded, size: 56, color: cs.onErrorContainer),
            ),
