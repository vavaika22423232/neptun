...
class ChatMessageListState extends ConsumerState<ChatMessageList> {
  ...
  void _onScroll() {
    ...
    if (state.hasMoreHistory && !state.isLoadingMore && state.messages.isNotEmpty) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ChatMessageBubble(
          ...
          myNickname: chatService.nickname,
          ...
          onPlayVoice: (id, url) => ref.read(chatControllerProvider.notifier).togglePlayback(id, url),
